...
# @ECLASS: qt5-build-r10000.eclass
# @MAINTAINER:
# qt@gentoo.org
# @AUTHOR:
...
if [[ ${CATEGORY} != dev-qt ]]; then
	die "qt5-build-r10000.eclass is only to be used for building Qt 5."
fi

case ${EAPI} in
	6)	: ;;
	*)	die "qt5-build-r10000.eclass: unsupported EAPI=${EAPI:-0}" ;;
esac
...
# @FUNCTION: qt5-build-r10000_src_unpack
# @DESCRIPTION:
# Unpacks the sources.
qt5-build-r10000_src_unpack() {
	if tc-is-gcc; then
...
# @FUNCTION: qt5-build-r10000_src_prepare
# @DESCRIPTION:
...
# @FUNCTION: qt5-build-r10000_src_configure
# @DESCRIPTION:
...
# @FUNCTION: qt5-build-r10000_src_compile
# @DESCRIPTION:
...
# @FUNCTION: qt5-build-r10000_src_test
# @DESCRIPTION:
# Runs tests in the target directories.
qt5-build-r10000_src_test() {
...
# @FUNCTION: qt5-build-r10000_src_install
# @DESCRIPTION:
...
# @FUNCTION: qt5-build-r10000_pkg_postinst
# @DESCRIPTION:
...
# @FUNCTION: qt5-build-r10000_pkg_postrm
# @DESCRIPTION:
...
# of this function must happen before calling qt5-build-r10000_src_configure.
qt_use_compile_test() {
	[[ $# -ge 1 ]] || die "${FUNCNAME}() requires at least one argument"
