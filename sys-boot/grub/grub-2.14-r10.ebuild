...
SLOT="2/${PVR}"
IUSE="+device-mapper doc efiemu +fonts mount nls protect sdl test +themes truetype"
...
pkg_postinst() {
	...
	if [[ -z ${REPLACING_VERSIONS} ]]; then
		...
		ewarn
		ewarn "Re-run grub2-install to update installed boot code!"
		ewarn "Re-run grub2-mkconfig to update grub.cfg!"
		ewarn
	fi
